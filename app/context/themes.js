const themes = [
  {
    name: "default",
    colorBg: "rgba(255, 255, 255, 0.3)", // Semi-transparent white background
    colorBg2: "rgba(200, 200, 255,0.5)", // Light purple background with transparency
    colorBg3: "rgba(255, 255, 255, 0.5)", // More opaque white background for glass effect
    colorBg4: "rgba(255, 255, 255, 0.8)", // Almost opaque white background for glass effect
    colorButton: "rgba(200, 200, 255, 0.5)", // Light purple button color with transparency
    colorDanger: "#fe6854", // Red danger color (unchanged)
    colorFontPrimary: "#e5e7eb",
    colorTextPrimary: "#FFFFFF", // White primary text color
    colorTextSecondary: "#B0B3B8", // Light grey secondary text color
